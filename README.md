...
| [prefer-active-doc](docs/rules/prefer-active-doc.md)                                                         | Prefer `activeDocument` and `activeWindow` over `document` and `window` for popout window compatibility.                                            | ✅ 🇬🇧 |        | 🔧 |
...
| [prefer-window-timers](docs/rules/prefer-window-timers.md)                                                   | Prefer `window.setTimeout()` and related timer functions over bare or `activeWindow` calls.                                                         | ✅ 🇬🇧 |        | 🔧 |
